...
def main(args):
    ...
    with open(os.path.join(args.data_root_path, 'anno_test.txt'), 'rb') as f:
        data_list = pickle.load(f)

    save_dir = os.path.join(args.save_dir, 'seg_result/')
    print(save_dir)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--data_root_path', type=str, default='/HDD/dataset/doosan/IN792sx_interrupt/')
    parser.add_argument('--image_path', type=str, default='/HDD/dataset/doosan/IN792sx_interrupt/images')
    parser.add_argument('--mask_path', type=str, default='/HDD/dataset/doosan/IN792sx_interrupt/segmentation_images')
    parser.add_argument('--save_dir', type=str, default='/HDD/tnwls/doosan/history/230705/IN792sx_interrupt/')
    parser.add_argument('--model_path', type=str, default='/HDD/tnwls/doosan/history/230228/IN792sx_interrupt/resnet18_4_32_real/saved_models')
